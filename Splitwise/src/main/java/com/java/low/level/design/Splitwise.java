...
public class Splitwise {
    ...
    public void demo() throws Exception {
        ...
        splits.add(split2);
        splits.add(split3);
        group.createExpense("Exp1001", "Breakfast", 900, userController.getUser("u001"), splits, SplitType.EQUAL);
        ...
        group.createExpense("Exp1002", "Lunch", 500, userController.getUser("u002"), splits2, SplitType.UNEQUAL);
